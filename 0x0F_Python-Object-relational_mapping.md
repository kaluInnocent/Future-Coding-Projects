...
-   Results must be sorted in ascending order by `states.id`
[O-   Results must be displayed as they are in the example below
-   Your code should not be executed when imported
